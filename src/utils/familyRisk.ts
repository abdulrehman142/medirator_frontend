...
const normalizeRelation = (relation: string): string => {
  ...
  if (normalized.includes("grandfather")) {
    if (normalized.includes("father") || normalized.includes("paternal"))
      return "paternal_grandfather";
    if (normalized.includes("mother") || normalized.includes("maternal"))
  ...
  if (normalized.includes("father") && !normalized.includes("grandfather"))
    return "father";
  if (normalized.includes("mother") && !normalized.includes("grandmother"))
    return "mother";
