          ...
          <section className="mt-6 rounded-2xl border-4 border-[#0B3C5D] bg-white dark:bg-black p-4 md:p-6">
            <div className="mx-auto w-full max-w-3xl">
              ...
              >
                ...
                {selectedFile && (
                  <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-[#0B3C5D] bg-white px-3 py-2 text-sm text-[#0B3C5D] dark:bg-black dark:text-white">
                    <span className="max-w-[16rem] truncate">
                      {t("auth", "selected", "Selected:")} {selectedFile.name}
                    </span>
                    <button
                      type="button"
