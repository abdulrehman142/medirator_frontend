    ...
    <div className="dark:text-white dark:bg-black font-sans leading-relaxed">
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col w-100 p-2 m-2 items-center">
          ...
          <div className="text-center text-xl font-bold p-1 m-1">
            {t("auth", "chooseAService", "Choose a Service")}
          </div>
        ...
        <div className="flex flex-col w-100 p-2 m-2 items-center">
          ...
          <div className="text-center text-xl font-bold p-1 m-1">
            {t("auth", "addAndOrganizeData", "Add and Organize Your Data")}
          </div>
          <div className="text-center text-[#5a6872] dark:text-white p-1 m-1">
            {t(
              "auth",
        ...
        <div className="flex flex-col w-100 p-2 m-2 items-center">
          ...
          <div className="text-center text-xl font-bold p-1 m-1">
            {t("auth", "getSmartInsights", "Get Smart Insights")}
          </div>
          <div className="text-center text-[#5a6872] dark:text-white p-1 m-1">
            {t(
              "auth",
