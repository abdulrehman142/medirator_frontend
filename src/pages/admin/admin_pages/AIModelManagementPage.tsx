  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <div className="flex flex-col md:flex-row justify-between items-center bg-[#0B3C5D] dark:bg-black text-white p-4 shadow-md gap-4">
        <div>
          <h2 className="text-3xl md:text-5xl font-bold ml-0 md:ml-5 md:pl-5 text-center md:text-left">AI Model Management</h2>
          <p className="text-sm md:text-base text-center md:text-left ml-0 md:ml-5 md:pl-5 mt-2 text-gray-200">
            Monitor model metrics, manage registry status, and review model logs.
          </p>
        </div>
        <img src={healthRisksImg} alt="AI Model Management" className="h-40 md:h-70 w-40 md:w-70" loading="lazy" />
      </div>
      ...
      <div className="dark:bg-black px-3 md:px-6 py-6 space-y-4 font-sans text-black dark:text-white">
        <section className="rounded-2xl border-4 border-[#0B3C5D] bg-white dark:bg-black p-4 md:p-6">
          <h3 className="text-lg md:text-xl font-semibold text-[#0B3C5D] dark:text-white">Model Metrics</h3>
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Total Models</div>
            ...
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Average Accuracy</div>
              <div className="mt-2 text-2xl font-bold text-[#0B3C5D] dark:text-white">{averageAccuracy}%</div>
            </div>
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Average Precision</div>
              <div className="mt-2 text-2xl font-bold text-[#0B3C5D] dark:text-white">{averagePrecision}%</div>
            </div>
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Average Recall</div>
              <div className="mt-2 text-2xl font-bold text-[#0B3C5D] dark:text-white">{averageRecall}%</div>
            </div>
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Average F1-Score</div>
              <div className="mt-2 text-2xl font-bold text-[#0B3C5D] dark:text-white">{averageF1Score}%</div>
            </div>
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Average AUC</div>
              <div className="mt-2 text-2xl font-bold text-[#0B3C5D] dark:text-white">{averageAuc}%</div>
            </div>
            <div className="rounded-2xl border border-[#0B3C5D] p-4">
              <div className="text-xs text-gray-500 dark:text-gray-400">Avg Inference Latency</div>
            ...
            <div className="rounded-2xl border border-[#0B3C5D] p-4 sm:col-span-2 xl:col-span-2">
              <div className="text-xs text-gray-500 dark:text-gray-400">Best Performing Model</div>
        ...
        <section className="rounded-2xl border-4 border-[#0B3C5D] bg-white dark:bg-black p-4 md:p-6">
          <h3 className="text-lg md:text-xl font-semibold text-[#0B3C5D] dark:text-white">Model Registry</h3>
            ...
            <table className="w-full min-w-[1320px] text-sm">
              <thead className="bg-[#0B3C5D] text-white">
                <tr>
                  ...
                  <th className="text-left px-4 py-3">F1-Score</th>
                  <th className="text-left px-4 py-3">Specificity</th>
                  <th className="text-left px-4 py-3">AUC</th>
